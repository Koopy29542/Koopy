...
# -----------------------------------------------------------------------------
# (1) 12-direction obstacle vector
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# (3) Koopman predictor with eigenmode truncation
# -----------------------------------------------------------------------------
class KoopmanPredictor:
    ...
    # Truncate Koopman matrix using top-k eigenmodes
    ...
    # One-step forward Koopman dynamics
...
# -----------------------------------------------------------------------------
# (5) Multi-mode trajectory generation
# -----------------------------------------------------------------------------
predictor = KoopmanPredictor(
    prediction_len=12,
    model_file='koopy_3.pkl',
    eig_top_k=20  # Load full K
)
...
# -----------------------------------------------------------------------------
# (6) Visualization of cumulative eigenmode effect
# -----------------------------------------------------------------------------
